			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding " >
						...
						<form class="form-inline line"  role="form" action="${pageContext.request.contextPath }/cpeSelectCountry/selectCountry" onsubmit="return submitMth()" style="margin-left: 25px;">
									...
									<td style="width: 20%;">
										<div class="form-group">
											<label class="sr-only" for="countryName"  style="margin-left: 15px;">村庄名称 </label>
											<input class="input-sm" type="text" name="countryName" id="countryName" value="${countryName}" placeholder="村庄名称">										
										</div>
									</td>
						...
						<section style="background-color:#E9DFF1;">
							...
							<c:forEach items="${dimCpecountryList}" var="countrylist">
								<tr>
									<td style=" padding: 0px;background-color:#9E88BD;border-top: #9E88BD;"><div class="firstd">&nbsp; <br></div></td>
									<td>${countrylist.cityName}</td>
									<td>${countrylist.countyName}</td>
									<td>${countrylist.townName}</td>
									<td>${countrylist.countryName}</td>
									
									<td>${countrylist.busiType1}</td>
									<td>${countrylist.netLockFlag}</td>
									<td>${countrylist.busiType}</td>
									
									<td>${countrylist.count}</td>
								</tr>
								</c:forEach>
							</tbody>
							<tfoot>
...
function submitMth(){
	...
	if(countryName.length==0&&cityName==0){
		alert('请填入村庄名称或城市名称');
		return false;
	}
}

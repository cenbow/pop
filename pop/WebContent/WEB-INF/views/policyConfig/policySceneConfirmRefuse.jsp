...
<body>
	...
	<form action="${ctx}/policyApproval/approvalConfirmNotPass" method="post">
	<input type="hidden" name="approvl_id" id="approvl_id" value="${confirm_ids}"/> 
	<input type="hidden" name="sucFlag" id="sucFlag" value="${sucFlag}"/>
	    <div class="widget-title">
			<h4>
				<i class="icon-reorder"></i>意见填写
			</h4>
		</div>

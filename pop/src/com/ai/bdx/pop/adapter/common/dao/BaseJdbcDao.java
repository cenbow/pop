...
package com.ai.bdx.pop.adapter.common.dao;
...
import com.ai.bdx.pop.adapter.common.constant.Constants;
import com.ai.bdx.pop.adapter.common.model.POPDw;
...
public class BaseJdbcDao {
    ...
    public Connection getConnection(POPDw popDw) throws SQLException, Exception {
        BasicDataSource ds = new BasicDataSource();
        ds=(BasicDataSource) getDataSorce(popDw);
        return ds.getConnection();
    }
    //创建数据仓库数据源，根据数据库的配置获取数据库链接
    public DataSource getDataSorce(POPDw popDw){
        BasicDataSource ds = new BasicDataSource();

package com.ailk.bdx.pop.adapter.model.custom;
...
public class CpeLockNetInfo implements Serializable{
	...
	public CpeLockNetInfo(String subsid, String productNo, String planCode,
			String policyNo, String lacCiDecId, int netLockFlag, 
			int busiType, String userLocation,List<String> userLocations, 
			String stationCode) {
		super();
		this.subsid = subsid;

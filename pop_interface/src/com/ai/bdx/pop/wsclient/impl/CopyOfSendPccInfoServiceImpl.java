 ...
 * 
 */
public class CopyOfSendPccInfoServiceImpl implements ISendPccInfoService {
	private static Logger log = Logger.getLogger(CopyOfSendPccInfoServiceImpl.class
			.getName());
 ...
 */
	public String cpeUserRegister(String phoneNo,String policId,List<String> location) throws SQLException{
		...
		String res1 = addSubscriber(phoneNo, sprBean);
		log.info("end to addCpeSubscriber----------->");
		if(res1.endsWith("0")){
			log.info("begin to unsubscribeUsrSessionPolicy----------->");
	...
	public String cpeUnUserPolicy(String phoneNo,String policId) throws SQLException{
		...
		log.info("end to cpeUnUserPolicy(去签约)----------->");
		return result;
	...
	public String cpeUserStatusChange(String phoneNo) throws SQLException, RemoteException{
		...
		log.info("end to delSubscriber----------->");
		log.info("start to cpeUserStatusChange----------->");
		return result;
	}
 ...
 */
	...
	public String singlePhoneOptWeb(String command, String phoneNo,
		...
		if(command.equals("1")){
			...
			//限速，先签约限速策略，再改变用户状态(将用状态改为2)
			String  res0 = subscribeUsrSessionPolicy(phoneNo, policyId, sprBean);
			if(res0.equals("0")){
				result = "1";
				String res1 = updateSubscriber(phoneNo, "2", sprBean);
				if(!res1.equals("0")){
					log.info("用户的状态更新失败,请联系PCC");
				}
			}
		}else if(command.equals("4")){
			//解除限速，先去签约限速策略，再改变用户状态(将用状态改为1)
			String  res0 = unsubscribeUsrSessionPolicy(phoneNo, policyId, sprBean);
			if(res0.equals("0")){
				result = "1";
	...
	public static void main(String[] args) throws Exception {
		CopyOfSendPccInfoServiceImpl impl = new CopyOfSendPccInfoServiceImpl();
		SprBusinessBean sprBean = new SprBusinessBean();
		 if(args!=null&&args.length!=0){
			 sprBean = impl.getSprBean(args[1]);
			if("adduserLocation1".equals(args[0])){
				 List<String> list = new ArrayList<String>();
				 list.add("130-4600029042077756417");
				 list.add("130-4600029042111271425");
				 list.add("130-4600029042111271426");
				 String res2 = impl.addUsrLocation(args[1], "12270010000000000000000000000005", list, sprBean);
				 System.out.println(res2);
			 }else if("adduserLocation2".equals(args[0])){
				 List<String> list = new ArrayList<String>();
				 list.add("130-1234567890123999");
				 String res2 = impl.addUsrLocation(args[1], "12270010000000000000000000000002", list, sprBean);
				 System.out.println(res2);
			 }else if("adduserLocations2".equals(args[0])){
				 List<String> list = new ArrayList<String>();
				 list.add("130-1234567890123999");
				 String res2 = impl.addUsrLocation(args[1], "12270010000000000000000000000002", list, sprBean);
				 System.out.println(res2);
			 }else if("updateUserLocationpd".equals(args[0])){
				 List<String> list = new ArrayList<String>();
				 list.add("130-4600028931112498689");
				 list.add("130-4600029042077756417");
				 list.add("130-4600029042111271425");
				 String res3 =  impl.updateUserLocation(args[1], "12270010000000000000000000000005", list, sprBean);
				 System.out.println(res3);
			 }else if("addPolicy".equals(args[0])){
				 String res4 = impl.subscribeUsrSessionPolicy(args[1], "12270010000000000000000000000004", sprBean);
				 System.out.println(res4);
			 }else if("deleteuser".equals(args[0])){
				 String res5 = impl.delSubscriber(args[1], sprBean);//销户
				 System.out.println(res5);
			 }else if("deletcpeuser".equals(args[0])){
				 String res5 = impl.delcpeSubscriber(args[1],"460000722009813",sprBean);
				 System.out.println(res5);
			 }else if("adduser".equals(args[0])){
				 String res6 = impl.addSubscriber(args[1], sprBean);
				 System.out.println(res6);
			 }else if("deleUserLocation".equals(args[0])){
				 String res7 = impl.deleUserLocation(args[1], "12270010000000000000000000000002", sprBean);
				 System.out.println(res7);
			 }else if("subscribeService".equals(args[0])){
				 String res7 = impl.subscribeService(args[1], "MP9990199002001", sprBean);
				 System.out.println(res7);
			 }else if("singlePhoneOpt".endsWith(args[0])){
				 ResultModel res = impl.singlePhoneOpt((short) 10,args[1],"MP9990199002001","1");
				 System.out.println(res.getResultCode());
			 }else if ("updateUsrSessionPolicy1".equals(args[0])) {
				String res = impl.updateUsrSessionPolicy(args[1], "12270010000000000000000000000004", sprBean);
				System.out.println(res);
			}else if ("updateUsrSessionPolicy2".equals(args[0])) {
				String res = impl.updateUsrSessionPolicy(args[1], "12270010000000000000000000000002", sprBean);
				System.out.println(res);
			}else if ("deleUserLocation".endsWith(args[0])) {
				String res = impl.updateUsrSessionPolicy(args[1], "12270010000000000000000000000005", sprBean);
				System.out.println(res);
			}else if("unsubscribeUsrSessionPolicy".endsWith(args[0])){
				String res6 = impl.unsubscribeUsrSessionPolicy(args[1], "12270010000000000000000000000004", sprBean);
				System.out.println(res6);
			}else if("addSubscriber".equals(args[0])){
				String res1 =  impl.addSubscriber(args[1], sprBean);
				System.out.println(res1);
			}else if("cpeUnUserPolicy".equals(args[0])){
				impl.cpeUnUserPolicy(args[1],"12270010000000000000000000000004");
			}else if("cpeUserRegister".equals(args[0])){
				List<String> location = new ArrayList<String>();
				location.add("130-4600028988111574530");
				String res =  impl.cpeUserRegister(args[1], "12270010000000000000000000000004", location);
				System.out.println(res);
			}else if("cpeUserNetLock".equals(args[0])){
				List<String> location = new ArrayList<String>();
				location.add("130-4600028988111574530");
				location.add("130-4600029167164184578");
				String res =  impl.cpeUserNetLock(args[1], "12270010000000000000000000000004", location);
				System.out.println(res);
			}
		 }
